  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.form}>
        ...
        {/* Off Days */}
        <View style={[styles.section, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <Text style={[styles.sectionTitle, { color: colors.text }]}>Weekly Off Days</Text>
          
          {[
            { key: 'off_sunday', label: 'Sunday' },
            { key: 'off_monday', label: 'Monday' },
            { key: 'off_tuesday', label: 'Tuesday' },
            { key: 'off_wednesday', label: 'Wednesday' },
            { key: 'off_thursday', label: 'Thursday' },
            { key: 'off_friday', label: 'Friday' },
            { key: 'off_saturday', label: 'Saturday' },
          ].map((day) => (
            <View key={day.key} style={styles.switchRow}>
              <Text style={[styles.label, { color: colors.text }]}>{day.label}</Text>
              <Switch
                value={formData[day.key as keyof EmployeeProfile] as boolean}
                onValueChange={(value) => setFormData({ ...formData, [day.key]: value })}
